...
trainValues = generate_train_samples(net,trigger.marker.x_values,trigger.marker.y_values,'samples','all');
trainValues2 = generate_train_samples(net,sets.x_values,sets.y_values,'samples','all'); 
...
testValues = generate_test_samples(net,trigger.marker.x_values,trigger.marker.y_values);
testValues2 = generate_test_samples(net,sets.x_values,sets.y_values);
